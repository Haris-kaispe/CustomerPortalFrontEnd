    ...
    <div className="py-2">
      ...
      <div className="border-b border-white/[0.08] mt-[2.2rem] md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10">
        <div className="top-bar-boxed flex items-center">
          {/* BEGIN: Logo */}
          <Link to="/top-menu/dashboard-overview-1" className="-intro-x hidden md:flex">
          ...
          <Dropdown className="intro-x mr-4 sm:mr-6">
            ...
            >
              <Lucide icon="shopping-cart" className="notification__icon dark:text-slate-500" />
            </DropdownToggle>
          </Dropdown>
          <Dropdown className="intro-x mr-4 sm:mr-6">
            <DropdownToggle
          ...
          <Dropdown className="intro-x w-8 h-8">
            ...
            >
              <img alt="Customer Portal - KAISPE" src={$f()[9].photos[0]} />
            </DropdownToggle>
            <DropdownMenu className="w-56">
              <DropdownContent className="bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                ...
                <DropdownItem className="hover:bg-white/5">
                  <Lucide icon="User" className="w-4 h-4 mr-2" /> P444rofile
                </DropdownItem>
                <DropdownItem className="hover:bg-white/5">
            ...
            <li key={menuKey}>
              ...
              >
                ...
                <div className="top-menu__title">
                  {menu.title}
                  {menu.subMenu && <Lucide icon="ChevronDown" className="top-menu__sub-icon" />}
                </div>
              </a>
              {/* BEGIN: Second Child */}
              {menu.subMenu && (
