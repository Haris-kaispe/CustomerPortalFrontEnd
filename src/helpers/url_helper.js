...
export const ADD_PRODUCT_IMAGE = "/products/upload";

export const UPDATE_SALES_ORDER_STATUS = "/order-management/update/orderStatusBulk?id=";

export const GET_VENDOR_LIST = "/vendor";
