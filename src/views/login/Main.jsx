...
import { Login as PostLogin } from "../../store/actions";
...
function Main() {
  ...
  useEffect(() => {
    ...
    console.log("VAue :", value, "----->", Login);

    if (
      value === "undefined" ||
      (value === "" && Login.hasOwnProperty("accessToken"))
    ) {
      // !Login.hasOwnProperty("accessToken")
      //     setLogin(Login);
      //      setToken(Login.accessToken);

      localStorage.setItem(Const.ACCESS_TOKEN, Login.accessToken);
