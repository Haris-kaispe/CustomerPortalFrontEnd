      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
          <button
            ...
            onClick={() => setAddUpdateModal({ show: true, type: "add" })}
          >
            Add New Product
          </button>
        ...
        {$_.take(productList.docs, productList.totalDocs).map((value, index) => (
          ...
          >
            <div className="box">
              ...
              <div className="justify-between flex items-center px-5 pb-5">
                <button
                  type="button"
                  className="btn btn-primary w-full mr-4"
                  onClick={() => setAddUpdateModal({ show: true, type: "edit", data: value })}
                >
                  Update
                </button>
                ...
                <button
                  ...
                  onClick={() => {
                    setDeleteConfirmationModal({ show: true, data: value });
                  }}
                >
                  Delete
                </button>
        ...
        <ModalBody className="p-0">
          ...
          <div className="px-5 pb-8 text-center">
            ...
            <button
              ...
              onClick={() => {
                dispatch(deleteProductList(deleteConfirmationModal?.data?._id));
                setDeleteConfirmationModal({
                  show: false,
                  data: null
                });
